...
namespace Telegram.ViewModels
{
    ...
    public partial class DialogBusinessRepliesViewModel : DialogViewModel, IDiffHandler<MessageViewModel>
    {
        ...
        private void Handle(UpdateQuickReplyShortcutMessages update)
        {
            ...
            {
                var message = new Message(x.Id, new MessageSenderUser(ClientService.Options.MyId), ClientService.Options.MyId, x.SendingState, null, true, false, false, false, false, false, false, false, false, false, 0, 0, null, null, null, null, null, null, null, null, null, 0, 0, x.ViaBotUserId, null, 0, 0, string.Empty, 0, string.Empty, x.MediaAlbumId, 0, null, string.Empty, x.Content, x.ReplyMarkup);
