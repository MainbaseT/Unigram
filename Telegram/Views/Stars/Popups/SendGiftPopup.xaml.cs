...
namespace Telegram.Views.Stars.Popups
{
    public sealed partial class SendGiftPopup : ContentPopup
    {
        ...
        public SendGiftPopup(IClientService clientService, INavigationService navigationService, Gift gift, MessageSender receiverId)
        {
            ...
            var content = new MessageGift(gift, clientService.MyId, _receiverId, string.Empty, new FormattedText(string.Empty, Array.Empty<TextEntity>()), gift.DefaultSellStarCount, 0, false, false, false, false, false, false, false, string.Empty, string.Empty);
            var message = new Message(0, new MessageSenderUser(clientService.Options.MyId), 0, null, null, false, false, false, false, false, false, false, false, false, 0, 0, null, null, null, Array.Empty<UnreadReaction>(), null, null, null, 0, null, null, 0, 0, 0, 0, 0, 0, string.Empty, 0, 0, null, content, null);
        ...
        private void OnTextChanged(object sender, RoutedEventArgs e)
        {
            ...
            if (_gift != null)
            {
                content = new MessageGift(_gift, _clientService.MyId, _receiverId, string.Empty, text, _gift.DefaultSellStarCount, Upgradeable.IsChecked is true ? _gift.UpgradeStarCount : 0, false, false, false, false, false, false, false, string.Empty, string.Empty);
            ...
            var message = new Message(0, new MessageSenderUser(_clientService.Options.MyId), 0, null, null, false, false, false, false, false, false, false, false, false, 0, 0, null, null, null, Array.Empty<UnreadReaction>(), null, null, null, 0, null, null, 0, 0, 0, 0, 0, 0, string.Empty, 0, 0, null, content, null);
