...
{
    public partial class IncrementalCollectionView<T, TSource> : MvxObservableCollection<T>, ISupportIncrementalLoading where TSource : IList<T>, ISupportIncrementalLoading, INotifyCollectionChanged
    {
